...
<script type="text/javascript">
	...
	loadScript("${BOOT_JS}/plugin/summernote/summernote.min.js", function(){
		loadScript("${BOOT_JS}/plugin/markdown/markdown.min.js", function(){
			loadScript("${BOOT_JS}/plugin/markdown/to-markdown.min.js", function(){
				loadScript("${BOOT_JS}/plugin/markdown/bootstrap-markdown.min.js", pagefunction);
			});
		});
	});
