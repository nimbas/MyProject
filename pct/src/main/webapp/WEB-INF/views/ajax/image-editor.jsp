					...
					<div class="widget-body">
						...
						<div id="myTabContent" class="tab-content">
							...
							<div class="tab-pane fade active in" id="s1">
								...
								<img src="${BOOT_IMG}/superbox/superbox-full-7.jpg" id="target-5" alt="[Jcrop Example]" class="pull-left" />
								...
								<div class="pull-left padding-gutter padding-top-0 padding-bottom-0">
									...
									<fieldset class="requiresjcrop">
										...
										<div class="btn-group">
											<button class="btn btn-default" id="${BOOT_IMG}2">
												Lego
											</button>
											<button class="btn btn-default active" id="${BOOT_IMG}1">
												Breakdance
											</button>
											<button class="btn btn-default" id="${BOOT_IMG}3">
												Dragon Fly
											</button>
										</div>
									</fieldset>
							...
							<div class="tab-pane fade" id="s2">
								...
								<img src="${BOOT_IMG}/superbox/superbox-full-11.jpg" id="target" alt="[Jcrop Example]" />
							...
							<div class="tab-pane fade" id="s3">
								...
								<img src="${BOOT_IMG}/superbox/superbox-full-10.jpg" id="target-2" alt="[Jcrop Example]" />
							...
							<div class="tab-pane fade" id="s4">
								...
								<img src="${BOOT_IMG}/superbox/superbox-full-9.jpg" id="target-3" alt="[Jcrop Example]" />

								<div id="preview-pane">
									<div class="preview-container">
										<img src="${BOOT_IMG}/superbox/superbox-full-9.jpg" class="jcrop-preview" id="target-3" alt="Preview" />
									</div>
								</div>
							...
							<div class="tab-pane fade" id="s5">
								...
								<div class="row">
									...
									<div class="col-sm-12 col-md-12 col-lg-12">
										...
										<img src="${BOOT_IMG}/superbox/superbox-full-7.jpg" id="target-4" alt="Jcrop Image" class="pull-left" />
							...
							<div class="tab-pane fade padding-10 no-padding-bottom" id="s6">
								...
								<img src="${BOOT_IMG}/superbox/superbox-full-16.jpg" id="target-6" alt="[Jcrop Example]" />
...
var jcrop_api_1, jcrop_api_2, jcrop_api_3, jcrop_api_4, jcrop_api_5, jcrop_api_6;
	...
	var pagefunction = function() {
		...
		var api_handler = function() {
			...
			var initJcrop = function(){
				...
				$('#target-5').Jcrop({
					...
					jcrop_api_1 = this;
					jcrop_api_1.animateTo([100, 100, 400, 300]);
			...
			$('#setSelect').click(function(e) {
				...
				jcrop_api_1.setSelect(getRandom());
			});
			$('#animateTo').click(function(e) {
				// Animates to a random selection
				jcrop_api_1.animateTo(getRandom());
			});
			...
			$('#img1').click(function(e) {
				...
				jcrop_api_1.setImage('img/superbox/superbox-full-7.jpg');
				jcrop_api_1.setOptions({
					bgOpacity : .6
				});
				return false;
			...
			$('#img2').click(function(e) {
				...
				jcrop_api_1.setImage('img/superbox/superbox-full-24.jpg');
				jcrop_api_1.setOptions({
					bgOpacity : .6
				});
				return false;
			...
			$('#img3').click(function(e) {
				...
				jcrop_api_1.setImage('img/superbox/superbox-full-20.jpg', function() {
					this.setOptions({
						bgOpacity : 1,
			...
			$('#ar_lock').change(function(e) {
				jcrop_api_1.setOptions(this.checked ? {
					aspectRatio : 4 / 3
				} : {
					aspectRatio : 0
				});
		...
		var basic_handler = function() {
			...
			$('#coords').on('change', 'input', function(e) {
				...
				jcrop_api_3.setSelect([x1, y1, x2, y2]);
			});
		...
		var aspect_ratio = function() {
			...
			$('#target-3').Jcrop({
				...
				boundx = bounds[0];
				boundy = bounds[1];
				// Store the API in the jcrop_api_4 variable
				jcrop_api_4 = this;

				// Move the preview into the jcrop container for css positioning
				$preview.appendTo(jcrop_api_4.ui.holder);
			});
		...
		var animation_handler = function() {
			...
			$('#anim_buttons .btn-group').append(create_btn('Bye!').click(function(e) {
				...
				jcrop_api_5.animateTo([300, 200, 300, 200], function() {
					this.release();
			...
			function animHandler(v) {
				return function(e) {
					$(e.target).addClass('active');
					jcrop_api_5.animateTo(v, function() {
						$(e.target).closest('.btn-group').find('.active').removeClass('active');
					});
					return false;
				};
		...
		var styling_handler = function () {
			...
			$('#target-6').Jcrop({
				...
				jcrop_api_6 = this;
				jcrop_api_6.setSelect([130, 65, 130 + 350, 65 + 285]);
				jcrop_api_6.setOptions({
					bgFade : true
				});
				jcrop_api_6.ui.selection.addClass('jcrop-selection');
			});
			...
			$('#buttonbar').on('click', 'button', function(e) {
				...
				$g.find('[data-setclass]').each(function() {
					...
					if (a) {
						jcrop_api_6.ui.holder.addClass(c);
						switch(c) {
						...
						jcrop_api_6.ui.holder.removeClass(c);
				});
			});
	...
	var pagedestroy = function(){
		...
		*/
		...
		if (debugState){
			root.console.log("✔ Jcrop destroyed");
		} 
	}

	// end destroy

	// load dependency and run pagefunction
	loadScript("${BOOT_JS}/plugin/jcrop/jquery.Jcrop.min.js", function() {
		loadScript("${BOOT_JS}/plugin/jcrop/jquery.color.min.js", pagefunction);
	});
