...
<script type="text/javascript">
	...
	var pagefunction = function() {
		...
		$("#spinner-currency").spinner({
		 ...
		 //Maxlength
		loadScript("${BOOT_JS}/plugin/maxlength/bootstrap-maxlength.min.js", runMaxLength);
		...
		loadScript("${BOOT_JS}/plugin/bootstrap-timepicker/bootstrap-timepicker.min.js", runTimePicker);
		...
		loadScript("${BOOT_JS}/plugin/noUiSlider/jquery.nouislider.min.js", noUiSlider);
		...
		loadScript("${BOOT_JS}/plugin/bootstrap-duallistbox/jquery.bootstrap-duallistbox.min.js", initializeDuallistbox);
		 ...
		 * COLOR PICKER
		 */
		loadScript("${BOOT_JS}/plugin/colorpicker/bootstrap-colorpicker.min.js", initializeColorpicker);
		...
		loadScript("${BOOT_JS}/plugin/bootstrap-tags/bootstrap-tagsinput.min.js", function(){
		 ...
		 * KNOB
		 */
		loadScript("${BOOT_JS}/plugin/knob/jquery.knob.min.js", startKnob);
		...
		loadScript("${BOOT_JS}/plugin/x-editable/moment.min.js", loadMockJax);
	
		function loadMockJax() {
		    loadScript("${BOOT_JS}/plugin/x-editable/jquery.mockjax.min.js", loadXeditable);
		}
	
		function loadXeditable() {
		    loadScript("${BOOT_JS}/plugin/x-editable/x-editable.min.js", loadTypeHead);
		}
	
		function loadTypeHead() {
		    loadScript("${BOOT_JS}/plugin/typeahead/typeahead.min.js", loadTypeaheadjs);
		}
	
		function loadTypeaheadjs() {
		    loadScript("${BOOT_JS}/plugin/typeahead/typeaheadjs.min.js", runXEditDemo);
		}
