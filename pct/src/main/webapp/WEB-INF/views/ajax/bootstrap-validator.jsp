...
<script type="text/javascript">
	...
	*/
	...
	var pagedestroy = function() {
		...
		$('#togglingForm').bootstrapValidator('destroy');
		$('#buttonGroupForm').bootstrapValidator('destroy');
		$('#productForm').bootstrapValidator('destroy');
		$('#profileForm').bootstrapValidator('destroy');
		$('#attributeForm').bootstrapValidator('destroy');
		$('#contactForm').bootstrapValidator('destroy');
	...
	loadScript("${BOOT_JS}/plugin/bootstrapvalidator/bootstrapValidator.min.js", pagefunction);
