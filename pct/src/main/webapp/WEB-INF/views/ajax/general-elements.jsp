					...
					<div class="well">
						...
						<div id="myCarousel-2" class="carousel slide">
							...
							<div class="carousel-inner">
								...
								<!-- Slide 2 -->
								<div class="item">
									<img src="${BOOT_IMG}/demo/m1.jpg" alt="">
								...
								<!-- Slide 3 -->
								<div class="item">
									<img src="${BOOT_IMG}/demo/m2.jpg" alt="">
				...
				<div class="col-sm-12 col-md-12 col-lg-6">
					...
					<div class="well">
						...
						<div class="text-center">
							<img src="${BOOT_IMG}/demo/demo-smartbig-alert.png" alt="demo" class="${BOOT_IMG}-responsive">
						</div>
	...
	<div class="row">
		...
		<div class="col-sm-12 col-md-12 col-lg-6">
			...
			<div class="well">
				...
				<ul class="media-list">
					<li class="media">
						<a class="pull-left" href="javascript:void(0);"> <img class="media-object" alt="64x64" src="${BOOT_IMG}/demo/64x64.png"> </a>
...
<script type="text/javascript">
	...
	loadScript("${BOOT_JS}/plugin/bootstrap-progressbar/bootstrap-progressbar.min.js", pagefunction);
