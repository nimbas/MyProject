...
<script type="text/javascript">
	...
	var pagefunction = function() {
		...
		*/	
	    ...
	    // custom toolbar
	    $("div.toolbar").html('<div class="text-right"><img src="${BOOT_IMG}/logo.png" alt="SmartAdmin" style="width: 111px; margin-top: 3px; margin-right: 10px;"></div>');
		...
		$('#datatable_tabletools').dataTable({
	        ...
	        "oTableTools": {
	            ...
	            "sSwfPath": "${BOOT_JS}/plugin/datatables/swf/copy_csv_xls_pdf.swf"
	        },
			"autoWidth" : true,
			"preDrawCallback" : function() {
				// Initialize the responsive datatables helper once.
	...
	loadScript("${BOOT_JS}/plugin/datatables/jquery.dataTables.min.js", function(){
		loadScript("${BOOT_JS}/plugin/datatables/dataTables.colVis.min.js", function(){
			loadScript("${BOOT_JS}/plugin/datatables/dataTables.tableTools.min.js", function(){
				loadScript("${BOOT_JS}/plugin/datatables/dataTables.bootstrap.min.js", function(){
					loadScript("${BOOT_JS}/plugin/datatable-responsive/datatables.responsive.min.js", pagefunction)
				});
			});
		});
	});
