...
<script type="text/javascript">
	...
	var pagefunction = function() {
		...
		loadScript("${BOOT_JS}/plugin/bootstrap-wizard/jquery.bootstrap.wizard.min.js", runBootstrapWizard);
		...
		loadScript("${BOOT_JS}/plugin/fuelux/wizard/wizard.min.js", fueluxWizard);
