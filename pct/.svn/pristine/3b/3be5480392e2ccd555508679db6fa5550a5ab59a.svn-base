...
public class ResourceUtil {
	...
	public ResourceUtil(MessageSource messageSource){
	...
	public static String getMessage(String messageResourceId, String[] messageParam) {
	...
	public static String getMessage(String messageResourceId, String language, String[] messageParam) {
		...
		try{
			...
			logger.error("MessageResourceId["+messageResourceId+"] is not defined!", e);
		}
